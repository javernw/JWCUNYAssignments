...
## Load Files Into R {.tabset .tabset-fade}
...
The DocumentTermMatrix function takes a corpus and create a data structure which is called called a Document Term Matrix and is compiled of rows and columns.
```{r message=FALSE, warning=FALSE}
...
## Model for assessing Non-Spam and Spam Emails
...
classify <- naiveBayes(trains, factor(training_data$score))

test_prediction <- predict(classify, newdata=test)
...
**For more information, please visit these sites:** <br/>
...
**Download files to directory here:**
